...
- AOP(Aspect Oriented Programming)，Spring定义切面，通过拦截点实现对不同业务之间的解耦
...
- 数据库配置，使用Properties工具，需要注意的是DriverManagerDataSource对于Properties的键值有一定要求。分别是url、username、password。或者使用DriverManagerDataSource(String,String,String)这个重载

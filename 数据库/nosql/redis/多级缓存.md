...
![image-20230421123154493](多级缓存.assets/image-20230421123154493.png)
...
![image-20230421143733482](多级缓存.assets/image-20230421143733482.png)
...
​	![image-20230421144607059](多级缓存.assets/image-20230421144607059.png)
...
​		![image-20230421145200003](多级缓存.assets/image-20230421145200003.png)
...
5. 测试
   ...
   ![image-20230421150817118](多级缓存.assets/image-20230421150817118.png)
...
![image-20230421151331188](多级缓存.assets/image-20230421151331188.png)
...
2. 获取参数
   ...
   ![image-20230421152314487](多级缓存.assets/image-20230421152314487.png)
...
3. 重载openrestry配置
   ...
   ![image-20230421152533954](多级缓存.assets/image-20230421152533954.png)
...
![image-20230421174611787](多级缓存.assets/image-20230421174611787.png)

> 测试：

![image-20230421174705745](多级缓存.assets/image-20230421174705745.png)

###### 封装http请求

在`nginx.conf`中我们引入了Lua模块:

![image-20230421174800173](多级缓存.assets/image-20230421174800173.png)
...
![image-20230421182222211](多级缓存.assets/image-20230421182222211.png)

###### 测试

> idea模拟集群。

![image-20230421182700420](多级缓存.assets/image-20230421182700420.png)

重命名分个组,启动即可

![image-20230421182753123](多级缓存.assets/image-20230421182753123.png)

1、3、4在8082,2、5在8081

![image-20230421183102204](多级缓存.assets/image-20230421183102204.png)
...
4. 测试
   ...
   ![image-20230421213648506](多级缓存.assets/image-20230421213648506.png)
...
![img](多级缓存.assets/687474703a2f2f646c2e69746579652e636f6d2f75706c6f61642f6174746163686d656e742f303038302f333038362f34363863316131342d653761642d333239302d396433642d3434616335303161373232372e6a7067.jpeg)
...
4. 测试
   ...
   ![image-20230422111821982](多级缓存.assets/image-20230422111821982.png)

   ![image-20230422111702806](多级缓存.assets/image-20230422111702806.png)
...
![image-20230423194408634](多级缓存.assets/image-20230423194408634.png)

## 总结

> 三级缓存架构：

![image-20230423194917573](多级缓存.assets/image-20230423194917573.png)
